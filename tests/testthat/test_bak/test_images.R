test_that("images",{
  ...
  pic1<-handle_openai$images_generations(prompt = "A small bird flies over the ocean, heading towards the storm.")
  test_dir = tempdir()
  ...
  pic3<-handle_openai$images_edits(image = pic_file2,prompt = "Please modify the bird in the picture to a flock of birds."
  ...
  pic4<-handle_openai$images_variations(image = pic_file1,n="2",size="256x256")
